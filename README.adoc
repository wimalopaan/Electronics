...
image::images/elrs_msw/RC_CRSF_HalfDuplex_Bus_SCH.PNG[width=240, ="images/elrs_msw/RC_CRSF_HalfDuplex_Bus_SCH.PNG"]

image::images/elrs_msw/RC_CRSF_HalfDuplex_Bus_PCB.PNG[width=240, ="images/elrs_msw/RC_CRSF_HalfDuplex_Bus_PCB.PNG"]
