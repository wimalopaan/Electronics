...
If you want to build this board, the https://github.com/wimalopaan/Electronics/blob/main/rc/boards/onoff_simple.T3001[Target3001] design file may be of interest.
