...
The differences to the <<msw_nucleo, nucleo>> are, that there is no programmer included (you habe to use a seperate `st-link` programmer, and that the pin assignments are different
...
| Output 6 | PA7 | P3-5
| Output 7 | PA8 | P3-4
| to receiver crsf tx | PA9 | P3-3 
| to receiver crsf rx | PA10 | P3-2
