...
This module can control up to 16 leds. These leds can be individually controlled, but also can be grouped into up to 4 groups.
...
The module is controlled via the _MultiSwitch Widget_ (like the <<mswe8>>), all settings are controllable via the `elrsV3.lua` or the _TBS Agent Lite`.
