...
* The switching in the time-domain witch a rectangular signal or convolution in the frequency domain of two _si()_ function results in a very broad spectrum. 
...
to the smallest frequency sprectrum of the resulting rf signal. Very good.
