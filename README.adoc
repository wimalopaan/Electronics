...
* Schrittweise Einführung der _automatischen Erkennung_ der Bus-Systeme: `IBus`, `SBus`, `SBus` (inv.), `Hott`. Darüber hinaus auch Detektion 
eines `PWM`-Signals (falls sinnvoll). 
