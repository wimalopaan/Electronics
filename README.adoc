...
image::images/elrs_msw/RCMultiSwitchSmall10_SCH.PNG[]

image::images/elrs_msw/RCMultiSwitchSmall10_PCB.PNG[]

===== MultiSwitch Widget

===== CRSF-Half-Duplex Bus

image::images/elrs_msw/RC_CRSF_HalfDuplex_Bus_SCH.PNG[}

image::images/elrs_msw/RC_CRSF_HalfDuplex_Bus_PCB.PNG[}
