...
[[elrs_custom]]
=== Building custom ELRS firmware

As described in <<gitpod_wm>> one can use https://gitpod.io[] to compile (custom) ELRS firmware. All you need is a appropriate configuration in your 
`github` repository.
