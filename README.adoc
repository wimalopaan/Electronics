...
image::https://github.com/wimalopaan/Electronics/tree/main/edgetx/sd/THEMES/wmd.png[Dayligt]

==== Theme für nachts

https://github.com/wimalopaan/Electronics/tree/main/edgetx/sd/THEMES/wmn.yml[Dayligt]

image::https://github.com/wimalopaan/Electronics/tree/main/edgetx/sd/THEMES/wmn.png[Dayligt]
